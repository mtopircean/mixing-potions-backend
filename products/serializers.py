...
class ProductSerializer(serializers.ModelSerializer):
    ...
    posts_used_in = PostSerializer(many=True, read_only=True, source='get_posts_used_in')
    used_by_users = ProfileSerializer(many=True, read_only=True, source='get_used_by_users')
